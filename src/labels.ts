...
export const L = {
  ...
  landingSubtitle:
    'یکی از ابزارهای زیر را انتخاب کنید. ابزارهای فعال محاسبه‌ها را به‌صورت آنی و بر مبنای ریال انجام می‌دهند.',
  landingToolsEyebrow: 'ابزارها',
  ...
  toolClaimsTitle: 'ارزیابی و تحلیل خسارت',
  toolClaimsDesc: 'برآورد و تحلیل خسارت بر مبنای شرایط بیمه‌نامه — به‌زودی در دسترس قرار می‌گیرد.',
  ...
  airFreightLimit: 'حمل هوایی — سقف تعهد (﷼)',
  airFreightRate: 'حمل هوایی — نرخ (‰)',
  ...
  debrisLimit: 'برداشت ضایعات — سقف هر رویداد (﷼)',
  ...
  // --- block 7: deductible ---------------------------------------------
  sec7: '۷) فرانشیز',
  deductibleStructure: 'ساختار فرانشیز عمومی',
  structPercentWithMin: 'درصدی از هر خسارت با حداقل مبلغ',
  structAmountOnly: 'فقط مبلغ ثابت',
  deductibleMinAmount: 'حداقل مبلغ فرانشیز (﷼)',
  deductiblePercent: 'درصد از هر خسارت',
  tplExcessPerMille: 'فرانشیز مسئولیت شخص ثالث (در هزارِ سقف تعهد)',
  excessCalibration: 'حداقل فرانشیز بازار محلی (﷼)',
  excessCalibrationRef: 'قلم مرجع (c-unit)',
  tableMinimumIRR: 'حداقل فرانشیز جدول برای این قلم',
  rebateFactor: 'ضریب تخفیف نرخ',
